...
class StillClock(Canvas):
	...
	# StillClock Class Object Constructor Initializer Method:
	def __init__(self, container):

		# Inherit Canvas Class Object Constructor Initializer Method:
		super().__init__(container)

		# Calls the setCurrentTime StillClock Class Object Method:
		self.setCurrentTime()

	# StillClock Class Object Accessor Methods:
	def getHour(self):
		return(self.__hour)
	...
	# StillClock Class Object Mutator Methods:
	...
	# StillClock Class Object Methods:
	def drawClock(self):
		...
		self.create_oval(width / 2 - radius, height / 2 - radius, width / 2 + radius,
			height / 2 + radius, tags = "clock")
